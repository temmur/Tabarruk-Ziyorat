<template>
    <div class="absolute top-6 w-[400px] bg-blurBack rounded-xl p-4">
        <ul class="grid grid-cols-2">
           <NavLists v-for="(el, idx) in CountriesInfo" :key="idx" :country="el.country" :des="el.destinations" :flag="el.flag"/>
        </ul>
    </div>
</template>
